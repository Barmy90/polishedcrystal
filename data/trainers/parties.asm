...
if DEF(FAITHFUL)
	...
	tr_mon 24, NOCTOWL, MALE
		tr_evs 64 HP, 64 Spe
		tr_moves HYPNOSIS, FORESIGHT, CONFUSION, MIRROR_COAT
endc
...
if DEF(FAITHFUL)
	...
	tr_mon 74, NOCTOWL @ SHARP_BEAK, MALE
		tr_moves HYPNOSIS, AIR_SLASH, DREAM_EATER, REFLECT
endc
...
VeteranMGroup:
	...
	tr_mon 38, NOCTOWL @ QUICK_CLAW
		tr_moves REFLECT, PSYCHIC_M, ROOST, AIR_SLASH
...
WalkerGroup:
	...
	tr_mon 72, NOCTOWL @ SHARP_BEAK
		tr_moves AIR_SLASH, PSYCHIC_M, ROOST, REFLECT
...
ReiGroup:
	...
	tr_mon 57, NOCTOWL @ QUICK_CLAW
		tr_evs 68 SAt, 252 Spe
		tr_moves EXTRASENSORY, AIR_SLASH, HYPNOSIS, DREAM_EATER
