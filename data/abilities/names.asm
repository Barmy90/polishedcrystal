...
Sturdy:          rawchar "Sturdy@"
Damp:            rawchar "Damp@"
Limber:          rawchar "Limber@"
SandVeil:        rawchar "Sand Veil@"
Static:          rawchar "Static@"
...
PoisonHeal:      rawchar "Poison Heal@"
Adaptability:    rawchar "Adaptability@"
SkillLink:       rawchar "Skill Link@"
